...
Page({
  ...
  data: {
    ...
    postcode: '301830',
    staticMapImage: 'https://gd-filems.dancf.com/mcm79j/mcm79j/51560/14bf5fd1-6de4-4631-aa89-229a8584f0cd11090736.jpg',
    markers: [{
      id: 0,
      latitude: 39.544736,
  ...
  makertap: function(e) {
    // console.log('9999999999999999', e)
    var id = e.markerId
    var that = this;
  ...
  goDetail: function() {
    ...
    wx.openLocation({ latitude, longitude, name, address: '学院', scale: 18 })
  },
  copyText: function (e) {
