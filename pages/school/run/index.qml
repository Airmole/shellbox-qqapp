...
<view class="bg-img" style="background-image: url({{fillImage}});">
  <view class="padding-xl text-black">
    <view class="padding-sm text-xl" wx:for="{{ranklist}}" wx:key="index">
      <view class="flex align-center">
        ...
        <view class="margin-tb-sm text-cut text-center" style="width: 250rpx;"><text class="text-lg">{{item.wechater ? item.wechater.nickname : item.qqer.nickname}}</text></view>
